...
class WGAN(object):
    ...
    def get_loss(self, D_p, D_n):
        D_loss = tf.reduce_mean(-D_p + D_n)
    ...
    def train(self, config):
        ...
        clip_D = [p.assign(tf.clip_by_value(p, -config.clip_critic, config.clip_critic)) for p in D_params]
