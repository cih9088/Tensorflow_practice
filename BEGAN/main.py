...
flags = tf.app.flags
flags.DEFINE_integer('batch_size', 16, 'Size of batches to use')
flags.DEFINE_float('g_lr', 0.00005, 'Learning rate for generator')
flags.DEFINE_float('d_lr', 0.00005, 'Learning rate for discriminator')
flags.DEFINE_float('beta1', 0.5, 'Momentum term of adamoptimizer')
flags.DEFINE_float('gamma', 0.5, 'Equilibrium paramter')
flags.DEFINE_float('lambda_', 0.001, 'k learning rate')
flags.DEFINE_integer('z_dim', 64, 'a number of z dimension layer')
