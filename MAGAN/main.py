...
from MAGAN import MAGAN

import tensorflow as tf
import pprint

flags = tf.app.flags
flags.DEFINE_integer('batch_size', 64, 'Size of batches to use')
flags.DEFINE_float('g_lr', 0.0005, 'Learning rate for generator')
flags.DEFINE_float('d_lr', 0.0005, 'Learning rate for discriminator')
flags.DEFINE_float('dae_lr', 0.0005, 'Learning rate for denoiser')
flags.DEFINE_float('beta1', 0.5, 'Momentum term of adamoptimizer')
flags.DEFINE_integer('z_dim', 50, 'a number of z dimension layer[50(mnist), 320(cifar10)]')
flags.DEFINE_string('z_dist', 'normal', 'Distribution for z [uniform, normal]')
