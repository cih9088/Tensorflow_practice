...
from DCGAN_DFM import DCGAN_DFM
...
flags.DEFINE_float('lambda_adv', 1., 'Lambda for adversarial objective')
flags.DEFINE_float('lambda_denoise', 0.03, 'Lambda for denoise objective')
...
def main(_):
    ...
    with tf.Session(config=run_config) as sess:
        gan = DCGAN_DFM(
            ...
            z_dim=FLAGS.z_dim,
            z_dist=FLAGS.z_dist,
            lambda_adv=FLAGS.lambda_adv,
            lambda_denoise=FLAGS.lambda_denoise
        )
